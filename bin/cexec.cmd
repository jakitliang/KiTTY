...
if not defined KITTY_USER_FLAGS (
  :: in case nothing was passed to %KITTY_USER_FLAGS%
...
:: echo.
:: echo %KITTY_USER_FLAGS%
:: echo %feNOT%
:: echo %feFlagName%
:: echo %feCommand%
:: echo %feParam%
:: echo.
echo %KITTY_USER_FLAGS% | %WINDIR%\System32\find /i "%feFlagName%">nul
if "%ERRORLEVEL%" == "0" (
  if "%feNOT%" == "false" (
...
echo.
echo Handles with custom arguments for kitty's init.bat.

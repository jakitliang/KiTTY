...
:::-------------------------------------------------------------------------------
    ...
    REM echo %path%|"C:\Users\dgames\kitty - dev\vendor\git-for-windows\usr\bin\wc" -c
    ...
    :toolong
        echo "%OLD_PATH%">"%temp%\kitty_lib_pathA"
        echo "%PATH%">"%temp%\kitty_lib_pathB"
        fc /b "%temp%\kitty_lib_pathA" "%temp%\kitty_lib_pathB" 2>nul 1>nul
        if errorlevel 1 ( del "%temp%\kitty_lib_pathA" & del "%temp%\kitty_lib_pathB" & goto :changed )
        del "%temp%\kitty_lib_pathA" & del "%temp%\kitty_lib_pathB"
        exit /b
